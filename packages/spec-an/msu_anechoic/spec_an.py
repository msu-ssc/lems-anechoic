...
__all__ = ["GpibDevice", "SpecAnConfig", "SpectrumAnalyzerHP8563E"]
...
class GpibDevice:
    ...
    def __init__(
        ...
        *,
        ...
        self.logger = logger or _create_null_logger()
...
class SpectrumAnalyzerHP8563E(GpibDevice):
    ...
    def find(
        ...
        *,
        ...
        ```
        """
        logger = logger or _create_null_logger()
    ...
    def get_config(self) -> "SpecAnConfig":
        """Get the config"""
        return SpecAnConfig.from_spec_an(self)
    ...
    def get_trace_frequencies_and_amplitudes(self, trace: Literal["A", "B"] = "A", *, sweep: bool = False) -> tuple[list[float], list[float]]:
