...
if __name__ == "__main__":
    ...
    for attempt in range(attempts):
        ssc_log.info(f"Attempt {attempt+1} of {attempts} to get initial turn table location . . . ")
        try:
    ...
    ssc_log.info("")
    ssc_log.info("==================== SETTING TURN-TABLE LOCATION ====================")
    ssc_log.info(f"Setting to az=0, el=0")
    set_turn_table_location(azimuth=0, elevation=0, turn_table=turn_table)
    ssc_log.info(f"Done Setting to az=0, el=0")
    ssc_log.info("")
    ssc_log.info("==================== QUERYING TURN-TABLE ====================")
    attempts = 30
    for attempt in range(attempts):
